...
\item[] Ph.D.,
        ...
        \begin{innerlist}
        \item Thesis Topic: \emph{How social information changes attention and memory during language processing and word learning}
        \item Advisor:
...
\begin{outerlist}
\item[] Graduate Research Fellowship, National Science Foundation (2014-present)
...
\item Sanchez, A., Meylan, S., Braginsky, M., {\bf MacDonald, K.}, Yurovsky, D., \& Frank, M. C. (in prep). childes-db: a flexible and reproducible interface to the Child Language Data Exchange System (CHILDES). Manuscript in preparation.
...
\begin{outerlist}
\item[] \emph{Continuing memberships in}: Cognitive Science Society, International Society for Infant Studies, Society for Research in Child Development
