...
Information-seeking, language comprehension, speed of processing, decision-making, sign language
...
\begin{outerlist}
\item[] B.A.,
             {Psychology} (with High Honors), May 2010
        \begin{innerlist}
         \item Thesis Topic: \emph{Group membership and preschoolers' selective trust}
         \item Advisor:
              \href{http://www.stanford.edu/~mcfrank/}
                   {Hilary Barth, Ph.D}
        \end{innerlist}
...
\textbf{Lab Manager} \hfill {May 2010 to August 2013}
\begin{innerlist}
...
\textbf{Research Assistant} \hfill {June 2008 to May 2010}
\begin{innerlist}
...
\item {\bf MacDonald, K.}, Blonder, A., Marchman, V.A., Fernald, A., \& Frank, M.C. (under review). An information-seeking account of eye movements during spoken and signed language processing.

\item {\bf MacDonald, K.}, Yurovsky, D., \& Frank, M.C. (under review). Social cues modulate the representations underlying cross-situational learning.

\item {\bf MacDonald, K.}, LaMarr, T., Corina, D., Marchman, V.A., \& Fernald, A. (under review). Real-time lexical comprehension in young children learning American Sign Language.
...
%
%\begin{bibsection}
%    \item Bion. R., {\bf MacDonald, K}., Marchman, V., \& Fernald, A. (in preparation). M-o-o-s as Cues: Young children map novel animal vocalizations to unfamiliar animals.
% \end{bibsection}

\section{Awards}

\begin{innerlist}
	\item[] NSF Graduate Research Fellowship, 2014
	\vspace{.1in}
...
Teaching Fellow \hfill {Fall 2014, Spring 2015}
\begin{innerlist}

\item[] Psych One\\
        Instructors: James Gross, Jamil Zaki, Greg Walton\\
        Department of Psychology,\\
        Stanford University
\end{innerlist}
...
Teaching Fellow \hfill {Fall 2009}
\begin{innerlist}
\item[] Developmental Psychology\\
