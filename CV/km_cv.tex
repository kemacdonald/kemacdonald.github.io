...
\textbf{Scientific Consultant} \hfill {2018 - present}
\begin{innerlist}
...
\item[] Ph.D.,
        ...
        \begin{innerlist}
        \item Thesis Topic: \emph{Integrating social and statistical information \\ during language comprehension and learning}
        \item Advisor:
...
\item[] Norman H. Anderson Travel Award, Stanford University  (2016, 2018bui)
...
\item {\bf MacDonald, K.}, LaMarr, T., Corina, D., Marchman, V.A., \& Fernald, A. (in press). Real-time lexical comprehension in young children learning American Sign Language. \emph{Developmental Science}.
...
\item Sanchez, A., Meylan, S., Braginsky, M., {\bf MacDonald, K.}, Yurovsky, D., \& Frank, M. C. (under review). childes-db: a flexible and reproducible interface to the Child Language Data Exchange System (CHILDES).

\item Hardwicke, T. E., Mathur, M. B., {\bf MacDonald, K.}, Nilsonne, G., Banks, G. C., Kidwell, M.C., Hofelich-Mohr, A., Clayton, E., Yoon, E.J., Tessler, M.H., Lenne, R., Altman, S., Long, B., \& Frank, M.C. (under review). Data availability, reusability, and analytic reproducibility: Evaluating the impact of a mandatory open data policy at the journal Cognition.
