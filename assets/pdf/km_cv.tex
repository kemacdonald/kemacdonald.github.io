...
\begin{document}
\makeheading{Kyle MacDonald, Ph.D.}
...
\href{http://comm.ucla.edu/}{UCLA} & 860-324-7315 \\
2225 Rolfe Hall  & \email{kemacdonald@ucla.edu} \\
Los Angeles, CA  90095  & \href{http://kemacdonald.com}{kemacdonald.com} \\
\end{tabular}
...
\textbf{Postdoctoral Researcher} \hfill {Jan 2019 - present}
\begin{innerlist}
...
\item[] Ph.D.,
        \href{https://psychology.stanford.edu/gradprogram}
             {Developmental Psychology}, 2013 - 2018
        \begin{innerlist}
        \item Thesis Topic: \emph{Children's information seeking during \\ signed and spoken language processing}
        \item Advisor:
              \href{http://www.stanford.edu/~mcfrank/}
                   {Michael C. Frank}
        \item Committee:
                    {Hyo Gweon, Virginia Marchman, \& \\
                    Jay McClelland}
        \end{innerlist}
\end{outerlist}
...
\item {\bf MacDonald, K.}, Marchman, V.A., Fernald, A., \& Frank, M.C. (submitted). Children flexibly seek visual information during signed and spoken language \\comprehension.

\item {\bf MacDonald, K.}, LaMarr, T., Corina, D., Marchman, V.A., \& Fernald, A. (2018). Real-time lexical comprehension in young children learning American Sign Language. \emph{Developmental Science}.
...
\item Sanchez, A., Meylan, S., Braginsky, M., {\bf MacDonald, K.}, Yurovsky, D., \& Frank, M. C. (2018). childes-db: a flexible and reproducible interface to the Child Language Data Exchange System (CHILDES).

\item Hardwicke, T. E., Mathur, M. B., {\bf MacDonald, K.}, Nilsonne, G., Banks, G. C., Kidwell, M.C., Hofelich-Mohr, A., Clayton, E., Yoon, E.J., Tessler, M.H., Lenne, R., Altman, S., Long, B., \& Frank, M.C. (2018). Data availability, reusability, and analytic reproducibility: Evaluating the impact of a mandatory open data policy at the journal Cognition.

\item {\bf MacDonald, K.}, Marchman, V.A., Fernald, A., \& Frank, M.C. (2018). Adults and preschoolers seek visual information to support language comprehension in noisy environments. \emph{Proceedings of the 40th Annual Meeting of the Cognitive Science Society.}

\item Yoon, E.J.*, {\bf MacDonald, K.*}, Asaba M., Gweon, H., \& Frank, M.C. (2018). Balancing informational and social goals in active learning. \emph{Proceedings of the 40th Annual Meeting of the Cognitive Science Society.}

\item {\bf MacDonald, K.}, Blonder, A., Marchman, V.A., Fernald, A., \& Frank, M.C. (2017). An information-seeking account of eye movements during spoken and signed language processing. \emph{Proceedings of the 39th Annual Meeting of the Cognitive Science Society.}
...
\item Frank, M.C., Lewis, M.L., \& {\bf MacDonald, K.}, (2016). A performance model for early word learning. \emph{Proceedings of the 38th Annual Meeting of the Cognitive Science Society.}

\item {\bf MacDonald, K.}, \& Frank, M.C. (2016). When does passive learning improve the effectiveness of active learning? \emph{Proceedings of the 38th Annual Meeting of the Cognitive Science Society.}

\item {\bf MacDonald, K.}, Yurovsky, D., \& Frank, M.C. (2015). Referential cues modulate attention and memory during cross-situational word learning. \emph{Proceedings of the 37th Annual Meeting of the Cognitive Science Society.}
...
\item {\bf MacDonald, K.}, Marchman, V.A., Fernald, A., \& Frank, M.C. (2018). Children's information seeking during signed and spoken language processing. Invited talk at UCLA Developmental Psychology speaker series.

\item {\bf MacDonald, K.}, Marchman, V.A., Fernald, A., \& Frank, M.C. (2018). Seeking visual information from social partners during language comprehension. Invited talk at Santa Clara University.

\item {\bf MacDonald, K.}, Marchman, V.A., Fernald, A., \& Frank, M.C. (2018). Adults and preschoolers seek visual information to support language comprehension in noisy environments. Oral presentation at the 40th Annual Meeting of the Cognitive Science Society.

\item {\bf MacDonald, K.}, Marchman, V.A., Fernald, A., \& Frank, M.C. (2018). An information-seeking account of eye movements during spoken and signed language processing. Symposium talk presented at the biennial International Conference on Infant Studies, Philadelphia, PA.
...
\item {\bf MacDonald, K.}, Blonder, A., Marchman, V.A., Fernald, A., \& Frank, M.C. (2017). An information-seeking account of eye movements during spoken and signed language processing. Oral presentation at the 39th Annual Meeting of the Cognitive Science Society, London, England.
...
\begin{outerlist}
\item[] \emph{Pre-Pi Representative}: DARCLE board
...
\item[] \emph{Ad-hoc reviewer}: Journal of Experimental Child Psychology, 
                                Cognitive Development, Cognition, Developmental Psychology, 
...
\item[] \emph{Data science}: data visualization, statistics (bayesian and frequentist approaches), experimental design, 
                            eye-tracking methods, natural language processing, Jekyll, Git, Github, Shiny
\end{outerlist}
